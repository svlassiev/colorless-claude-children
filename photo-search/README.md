...
This module follows the repo-level strict rule: all operations run as `svlassiev` on GCP project `thematic-acumen-225120`. Never `a work username` or any Epidemic Sound identity. See the root `CLAUDE.md` for the full identity table.
